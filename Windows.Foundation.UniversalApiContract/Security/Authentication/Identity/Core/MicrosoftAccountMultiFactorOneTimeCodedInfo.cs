...
// Type: Windows.Security.Authentication.Identity.Core.MicrosoftAccountMultiFactorOneTimeCodedInfo
...
namespace Windows.Security.Authentication.Identity.Core
{
  ...
  public sealed class MicrosoftAccountMultiFactorOneTimeCodedInfo : 
    IMicrosoftAccountMultiFactorOneTimeCodedInfo
  {
    ...
    /// <summary>This API is for internal use only and should not be used in your code.</summary>
    /// <returns>This API is for internal use only and should not be used in your code.</returns>
    public extern TimeSpan TimeInterval { [MethodImpl] get; }

    /// <summary>This API is for internal use only and should not be used in your code.</summary>
    /// <returns>This API is for internal use only and should not be used in your code.</returns>
    public extern TimeSpan TimeToLive { [MethodImpl] get; }
