...
// Type: Windows.UI.Input.Inking.Analysis.InkAnalysisRoot
...
namespace Windows.UI.Input.Inking.Analysis
{
  ...
  public sealed class InkAnalysisRoot : IInkAnalysisRoot, IInkAnalysisNode
  {
    ...
    /// </returns>
    [MethodImpl]
    public extern IVectorView<IInkAnalysisNode> FindNodes(
      InkAnalysisNodeKind nodeKind);
