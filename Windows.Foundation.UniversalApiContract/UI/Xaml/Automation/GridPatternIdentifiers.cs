...
// Type: Windows.UI.Xaml.Automation.GridPatternIdentifiers
...
namespace Windows.UI.Xaml.Automation
{
  ...
  [Static(typeof (IGridPatternIdentifiersStatics), 65536, "Windows.Foundation.UniversalApiContract")]
  ...
  public sealed class GridPatternIdentifiers : IGridPatternIdentifiers
  {
    ...
    public static extern AutomationProperty ColumnCountProperty { [MethodImpl] get; }

    /// <summary>Identifies the RowCount automation property.</summary>
    /// <returns>The automation property identifier.</returns>
    public static extern AutomationProperty RowCountProperty { [MethodImpl] get; }
  }
}
