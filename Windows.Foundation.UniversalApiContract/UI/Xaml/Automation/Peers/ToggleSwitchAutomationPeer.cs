...
namespace Windows.UI.Xaml.Automation.Peers
{
  ...
  [Composable(typeof (IToggleSwitchAutomationPeerFactory), CompositionType.Public, 65536, "Windows.Foundation.UniversalApiContract")]
  [WebHostHidden]
    ...
    IToggleProvider
  {
    ...
    [MethodImpl]
    public extern ToggleSwitchAutomationPeer(ToggleSwitch owner);
