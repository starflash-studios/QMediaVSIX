...
namespace Windows.Media.Protection.PlayReady
{
  ...
  public sealed class PlayReadyDomainJoinServiceRequest : 
    ...
    IMediaProtectionServiceRequest
  {
    ...
    [MethodImpl]
    public extern PlayReadyDomainJoinServiceRequest();
    ...
    public extern string DomainFriendlyName { [MethodImpl] get; [MethodImpl] set; }
