...
// Type: Windows.Media.Protection.PlayReady.PlayReadySecureStopIterator
...
namespace Windows.Media.Protection.PlayReady
{
  ...
  public sealed class PlayReadySecureStopIterator : IIterator<IPlayReadySecureStopServiceRequest>
  {
    ...
    public extern IPlayReadySecureStopServiceRequest Current { [MethodImpl] get; }
    ...
    [MethodImpl]
    public extern uint GetMany([Out] IPlayReadySecureStopServiceRequest[] items);
  }
}
