...
namespace Windows.Data.Xml.Dom
{
  ...
  public sealed class DtdEntity : IDtdEntity, IXmlNode, IXmlNodeSerializer, IXmlNodeSelector
  {
    ...
    public extern object PublicId { [MethodImpl] [return: Variant] get; }
    ...
    public extern object SystemId { [MethodImpl] [return: Variant] get; }

    /// <summary>Gets the notation name.</summary>
    /// <returns>The notation name.</returns>
    public extern object NotationName { [MethodImpl] [return: Variant] get; }
