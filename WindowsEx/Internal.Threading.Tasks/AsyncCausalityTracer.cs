...
namespace System.Threading.Tasks {
    internal static class AsyncCausalityTracer {
        ...
        [MethodImplAttribute(MethodImplOptions.NoInlining)]
        internal static void TraceSynchronousWorkStart( Task task, WFD.CausalitySynchronousWork work ) {
            try {
                int taskId = task.Id;
                if ( (f_LoggingOn & Loggers.ETW) != 0 )
        ...
        [MethodImplAttribute(MethodImplOptions.NoInlining)]
        internal static void TraceSynchronousWorkCompletion( WFD.CausalitySynchronousWork work ) {
            try {
                if ( (f_LoggingOn & Loggers.ETW) != 0 )
