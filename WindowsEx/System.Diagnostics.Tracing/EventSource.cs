...
;
    ...
    internal struct SessionMask {
        ...
        public SessionMask( uint mask = 0 ) { m_mask = mask & MASK; }
        ...
        public static explicit operator ulong( SessionMask m ) { return m.m_mask; }

        public static explicit operator uint( SessionMask m ) { return m.m_mask; }
