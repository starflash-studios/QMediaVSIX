...
namespace QMediaVSIX.Commands {
    ...
    internal sealed class CommandsSkipRev {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="CommandsSkipRev"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="Package">Owner package, not null.</param>
        /// <param name="CommandService">Command service to add command to, not null.</param>
        CommandsSkipRev(AsyncPackage Package, OleMenuCommandService CommandService) {
            _Package = Package ?? throw new ArgumentNullException(nameof(Package));
            CommandService = CommandService ?? throw new ArgumentNullException(nameof(CommandService));

            CommandID MenuCommandID = new CommandID(CommandSet, CommandId);
            OleMenuCommand MenuItem = new OleMenuCommand((_, __) => CommandsGlobal.CurrentSessionSkipPrevAsync(_Package as QMediaVSIXPackage).Invoke(), MenuCommandID) {
                Text = AppTranslations.CmdSkipRev.TooltipText
            };
            CommandService.AddCommand(MenuItem);
        }

        /// <summary> Gets the instance of the command. </summary>
        public static CommandsSkipRev Instance {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage Package) {
            ...
            Instance = new CommandsSkipRev(Package, CommandService);
        }
    }
}
